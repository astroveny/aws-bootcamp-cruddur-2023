...
```
```bash
$ cat config  <font color="green">#updated local config file</font>
Host git-codecommit.us-east-1.amazonaws.com
  User ***************FFCH2
  IdentityFile ~/.ssh/codecommit_rsa
```
```bash
$ ssh  git-codecommit.us-east-1.amazonaws.com  [+ GREEN #Testing access to CodeCommit +]
...
<img width="600" height="350" alt="image" src="https://user-images.githubusercontent.com/91587569/219622076-c9eae6ef-fa24-47d6-ba9f-214706e00d07.png">
